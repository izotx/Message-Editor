...
- (float)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"Data Height %f: for row: %d",MAX(data.insets.top + data.view.frame.size.height + data.insets.bottom, self.showAvatars ? 52 : 0),indexPath.row);
...
//
//    
//    NSBubbleData * data = tableCell.data;
//    
...
//    if([[tableView cellForRowAtIndexPath:indexPath] isKindOfClass:[UIBubbleHeaderTableViewCell class]]){
//        UIBubbleHeaderTableViewCell * tableCell =   (UIBubbleHeaderTableViewCell*)[tableView cellForRowAtIndexPath:indexPath];
//        NSLog(@"Header Data date: %@",tableCell.date);
//        
//        
//    }
    
    if([[tableView cellForRowAtIndexPath:indexPath] isKindOfClass:[UIBubbleTableViewCell class]]){
        UIBubbleTableViewCell * tableCell =   (UIBubbleTableViewCell*)[tableView cellForRowAtIndexPath:indexPath];
        NSBubbleData * data = tableCell.data;
        
        [self.viewControllerTarget selectedCellWithData: data];
